...
import 'package:sosdoctorsystem/services/schedules_service.dart';
...
class CreateSchedulesScreen extends StatefulWidget {
  static const String id = 'createschedules-screen';
  const CreateSchedulesScreen({Key? key}) : super(key: key);

  @override
  State<CreateSchedulesScreen> createState() => _CreateSchedulesScreenState();
}
...
class _CreateSchedulesScreenState extends State<CreateSchedulesScreen> {
  ...
  void _createOccorrence() async {
    ApiResponse response = await createSchedules(
